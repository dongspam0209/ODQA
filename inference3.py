...
import torch
from utils.arguments_inference3 import ModelArguments, DataTrainingArguments, OurTrainingArguments
...
def main():
    ...
    # datasets=load_from_disk("./resources/retrieval/final_clean_top40_dpr2+bm25_retrieval_dataset")
    datasets=load_from_disk("./resources/retrieval/bm25_origin")
