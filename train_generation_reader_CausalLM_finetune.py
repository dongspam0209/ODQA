...
def main():
    ...
    # config = PeftConfig.from_pretrained("./resources/checkpoint/koquadv1+aihub")
    model = PeftModelForCausalLM.from_pretrained(model, "./resources/checkpoint/koquadv1+aihub/checkpoint-2000")
