...
def search_evaluation(q_encoder, tokenizer, test_dataset, faiss_index, text_index, text, title, 
    ...
    get_topk_document(question_test_idx, question, question_idx, text_index, text, title, "./resources/retrieval/final_clean_top40_bm25_retrieval_dataset")
    ...
    get_topk_document(I, question, question_idx, text_index, text, title, "./resources/retrieval/final_clean_top40_dpr2+bm25_retrieval_dataset")
...
def argument_parser():
    ...
    parser.add_argument('--faiss_path', type=str,
                        ...
                        default='./database/pickles_kiwi_main_hf_dpr2_no/faiss_pickle.pkl',
                        help='Path of faiss pickle'
                       )
    parser.add_argument('--bm25_path', type=str,
                        # default='./database/pickles_kiwi_main_hf/faiss_pickle.pkl',
                        default='./database/pickles_kiwi_main_hf_dpr2_no/bm25_pickle.pkl',
                        help='Path of BM25 Model'
                       )
    parser.add_argument('--context_path', type=str,
                            default='./database/pickles_kiwi_main_hf_dpr2_no/context_pickle.pkl',
                            help='Path of BM25 Model'
                        )
