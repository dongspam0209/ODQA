...
import torch
from utils.arguments_inference_ import ModelArguments, DataTrainingArguments, OurTrainingArguments
...
from database.retrieval import run_retrieval
...
def main():
    ...
    # retrieval 방식 선택
    if model_args.retireval_file_path:
        NotImplemented
    else:
        datasets = run_retrieval(model_args, data_args, training_args, datasets)
